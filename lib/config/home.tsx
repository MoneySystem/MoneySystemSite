  ...
  intros: [
    {
      ...
      content: (
        <>
          ...
          <br />
          <div>
            Junte-se a nós to build a toolbox that empowers anyone to create their own system — play and tweak without
            limits.
          </div>
        </>
      ),
    ...
    },
    {
      ...
      btnLink: 'https://moneysystem.com.br/essential-documentation/readme/welcome-to-appflowy',
      image: {
