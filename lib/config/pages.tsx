      ...
      desc: (
        <div className={'our-mission-desc'}>
          ...
          <div className={'list'}>
            ...
            <div>
              Make integration and customization easy with no vendor lock in. Add MoneySystem into your existing
              workflows or build a customized workspace with our open source building blocks such as MoneySystem Editor
              and Kanban Board.
            </div>
            <div>
  ...
  communityData: [
    {
      ...
      link: {
        text: 'Get started',
        href: 'https://moneysystem.com.br/documentation/software-contributions/contributing-to-appflowy\n',
      },
    },
    {
      value: 32,
    ...
    logos: [
      {
        name: 'grupor5brasil',
        logo: '/images/gr5.svg',
        darkLogo: '/images/gr5.svg',
      },
      {
        name: 'lunarfilm',
        logo: '/images/lunarfilm.png',
        darkLogo: '/images/lunarfilm.png',
      },
      {
        name: 'cdmmkt',
        logo: '/images/cdm.webp',
        darkLogo: '/images/cdm.webp',
      },
      {
        name: 'americancut',
        logo: '/images/americancut.svg',
        darkLogo: '/images/americancut.svg',
      },
      {
        name: 'garagem66',
        logo: '/images/garagem66.png',
        darkLogo: '/images/garagem66.png',
      },
      {
        name: 'colorstable',
        logo: '/images/colorstable.svg',
        darkLogo: '/images/colorstable.svg',
      },
      {
        name: 'nouv',
        logo: '/images/nouv.webp',
        darkLogo: '/images/nouv.webp',
      },
      {
        name: 'r5wf',
        logo: '/images/r5wf.svg',
        darkLogo: '/images/r5wf.svg',
      },
      {
        name: 'flatglass',
        logo: '/images/flatglass.png',
        darkLogo: '/images/flatglass.png',
      },
      {
        name: 'antichipppf',
        logo: '/images/antichip.png',
        darkLogo: '/images/antichip.png',
      },
    ],
  },
...
export const contributorsPageConfig = {
  ...
  learnMoreLink: 'https://moneysystem.com.br/documentation/software-contributions/contributing-to-appflowy',
};
