      ...
      <div className={'content'}>
        <div className={'content-wrapper'}>
          ...
          <button className={'visited-btn mb-6 w-[400px] max-w-full rounded-2xl bg-[#00A1CE] py-4 text-white'}>
            <Link href={'/download#pop'}>Download MoneySystem</Link>
          </button>
          <div className={'w-[400px] max-w-full whitespace-break-spaces break-words text-center text-[18px]'}>
            Need help?{' '}
            <a className={'font-semibold text-[#00A1CE] underline'} href={'https://api.whatsapp.com/send?phone=5548988745520&text=Ol%C3%A1!%20Tenho%20interesse%20no%20MoneySystem'}>
