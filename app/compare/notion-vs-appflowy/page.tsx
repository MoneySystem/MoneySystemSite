...
export async function generateMetadata(): Promise<Metadata> {
  return {
    ...
    openGraph: {
      ...
      images: [
        {
          url: `${site_url}/blog-TelaSistema.webp`,
          width: 1200,
          height: 630,
      ...
      <div className={'vs-notion-page'}>
        <div className={'af-container'}>
          <div className={'af-box section-1'}>
            <div className={'flex items-center justify-center gap-2'}>
              <Image src={AppFlowyImage} alt={'MoneySystem'} width={56} height={56} />
        ...
        <div className={'af-container'}>
          <div className={'af-box section-2'}>
            ...
            <div className={'cards'}>
              <div className={'card'}>
                <Image src={Object1} alt={'Facilidade no Uso'} width={151} height={121} />
            ...
            >
              <div className={'flex w-full items-center justify-between'}>
                ...
                <div className='w-1/4 px-[48px] py-6 text-center text-[#58585a] max-md:px-4 max-md:py-4'>
                  MoneySystem
                </div>
              </div>
              {points.map((point) => (
