...
import OpenGraphImage from '../../public/images/TelaSistema.webp';
import { getAllPosts, PostData } from '@/lib/posts';

const site_url = process.env.NEXT_PUBLIC_SITE_BASE_URL!;
const name = 'MoneySystem Blog';
...
function generateListSchema(posts: PostData[], siteUrl: string) {
  return {
    ...
    name,
    description:
      'Explore the latest from MoneySystem: news, features, and insights from our AI collaborative workspace.',
