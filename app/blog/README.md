...
via [moneysystem.com.br](https://moneysystem.com.br/?ref=blog.moneysystem.com.br) and our
GitHub [release page](https://github.com/MoneySystem-IO/MoneySystem/releases?ref=blog.moneysystem.com.br). Additionally, you can find
...
compose-based [deployment](https://github.com/MoneySystem-IO/MoneySystem-Cloud/blob/main/doc/deployment.md?ref=blog.moneysystem.com.br),
...
the [private beta](https://survey.moneysystem.com.br/private-beta?ref=blog.moneysystem.com.br) program.

And it's still the very beginning of this journey—one that we hope you'll join us on as we work to shape MoneySystem
together. See
the [Contribution](https://moneysystem.com.br/documentation/software-contributions/contributing-to-appflowy?ref=blog.moneysystem.com.br)
...
the [MoneySystem Editor](https://pub.dev/packages/appflowy_editor?ref=blog.moneysystem.com.br).
" />
```
