...
function generateListSchema(slug: string, post: PostData, siteUrl: string) {
  return {
    ...
    '@type': 'BlogPosting',
    headline: post.title,
    image: post.og_image || `${siteUrl}/blog-TelaSistema.webp`,
    ...
    <>
      ...
      >
        <Link
          href={'/blog'}
          className={
            'absolute left-[56px] top-[160px] flex cursor-pointer select-none items-center gap-2 py-2 text-base hover:text-primary max-xl:top-[120px] max-md:left-0 max-md:top-[100px] max-md:w-full max-md:justify-start max-sm:px-6'
          }
        >
          <ArrowLeftIcon />
          Voltar
