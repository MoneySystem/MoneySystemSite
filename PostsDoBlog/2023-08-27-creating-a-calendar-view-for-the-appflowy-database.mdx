...
by [Richard](https://github.com/richardshiue?ref=blog.moneysystem.com.br), as part of the [MoneySystem Mentorship Program](https://moneysystem.com.br/essential-documentation/contribute-to-appflowy/appflowy-mentorship-program/contributor-guidance?ref=blog.moneysystem.com.br)
...
<Img
  src='/images/blog/creating-a-calendar-view-for-the-appflowy-database/image-1.png'
  alt='Edit a book status'
  caption='The book status can be easily chosen using the menu.'
/>
...
<Img
  src='/images/blog/creating-a-calendar-view-for-the-appflowy-database/image-2.png'
  alt='Edit a book status'
  caption='The properties of a book along with the rich-text editing area below it.'
/>
...
<Img
  src='/images/blog/creating-a-calendar-view-for-the-appflowy-database/image-3.png'
  alt='Edit a book status'
  caption='The grid views lays out data in rows and columns'
/>
...
<Img
  src='/images/blog/creating-a-calendar-view-for-the-appflowy-database/image-4.png'
  alt='Edit a book status'
  caption='The kanban board groups similar rows together'
/>
...
Our [MoneySystem-Collab](https://github.com/MoneySystem-IO/MoneySystem-Collab?ref=blog.moneysystem.com.br) crate is responsible for data synchronization and storage throughout the entire application. In it, the `yrs` crate is used to store the data and support [Conflict-free Replicated Data Type (CRDT)](https://crdt.tech/?ref=blog.moneysystem.com.br).
...
We use the [calendar_view](https://pub.dev/packages/calendar_view?ref=blog.moneysystem.com.br) package to implement it, which provides a healthy level of customization and usability features.

This is our current design:

<Img
  src='/images/blog/creating-a-calendar-view-for-the-appflowy-database/image-5.png'
  alt='Edit a book status'
  caption='This calendar displays the rows from our books example using the return dates'
/>
...
Thanks for reading this article. If you have some time, please kindly take our [1-minute survey](https://tally.so/r/m6jWXo?ref=blog.moneysystem.com.br) to give us feedback and let us know what interests you the most.
