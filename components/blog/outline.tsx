    ...
    >
      <div ref={outlineRef} className={'flex w-full flex-col gap-[30px] max-md:gap-4'}>
        <div className={cn('prose-toc hidden w-full gap-2 rounded-[10px] bg-[#EEEEFD] p-10 max-xl:p-4 lg:block')}>
          <h2 className='mb-4 text-[24px] font-semibold leading-[31px]'>Índice de conteúdo</h2>
        ...
        <div className={'flex w-full items-center gap-5'}>
          <span className={'text-black opacity-50'}>Compartilhar</span>
          <Share content={'Veja este artigo! '} />
        </div>
      </div>
    </div>
  );
