...
function MainProducts() {
  ...
  const tabOptions = useMemo(() => {
    return [
      ...
      { value: 'projects', label: 'Vendas', icon: <ProjectsIcon /> },
      { value: 'tasks', label: 'DRE', icon: <KanbanIcon /> },
      { value: 'templates', label: 'Clientes', icon: <TemplateIcon /> },
      { value: 'sites', label: 'Relatórios', icon: <Website /> },
    ];
  }, []);
